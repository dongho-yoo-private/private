...
public:
	...
	// ------------------------------
	static ePacketResult WriteNormalPacket(int sock, ssyNormalPacket& packet, sSecurityInfo& info, Bool bIsSyn=False); 

	// ------------------------------
	static ePacketResult WriteNormalPacket(int sock, ssyNormalPacket& packet, const void* extData, int extSize, sSecurityInfo& info, Bool bIsSyn=False); 
	...
	// ------------------------------
	static void blocking(int sock, Bool bIsBlock);
};
