...
#define xGET_GOBAN_MODE(flag) ((eGoContentsMode)xBITZ_VALUE(flag, 29, 26))
#define xSET_GOBAN_MODE(flag, value) (flag=((xCLEAR_BITZ(flag, 29, 26)|((bit32_t)value<<26))))

#define xGET_GOBAN_STATUS(flag) ((eCurrentState)xBITZ_VALUE(flag, 25, 23))
#define xSET_GOBAN_STATUS(flag, value) (flag=((xCLEAR_BITZ(flag, 25, 23)|((bit32_t)value<<23))))

#define xGET_GO_FORMAT(flag) ((eGoFileType)xBITZ_VALUE(flag, 22, 21))
#define xSET_GO_FORMAT(flag, value) (flag=((xCLEAR_BITZ(flag, 22, 21)|((bit32_t)value<<21))))
...
#ifdef _WIN32
class xEXPORT cyiGoEngine : public cyiBase
#else
...
public:
	...
	// --------------------------------
	static ubit8_t* CreateMapBitz(cyiTreeNode* node);

	// --------------------------------
	static cyiTreeNode* GoLastNode(cyiTreeNode* node);

	// --------------------------------
	static cyiTreeNode* GoTopNode(cyiTreeNode* node);


	// --------------------------------
	static stone_t* CreateBitzMap(stonemap_t map);
	...
	// --------------------------------
	int GetNextStonez(stone_t* buffer);
	...
	// -----------------------------------
	cyiTreeNode* GetNode(stone_t* stone);
