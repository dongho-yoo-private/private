================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: YotsuyaClient プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した YotsuyaClient には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには YotsuyaClient アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

YotsuyaClient.vcproj
...
YotsuyaClient.h
   ...
   CYotsuyaClientApp アプリケーション クラスを宣言します。

YotsuyaClient.cpp
   これは、アプリケーション クラス CYotsuyaClientApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\YotsuyaClient.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル YotsuyaClient.rc に含まれていま
   す。

res\YotsuyaClient.rc2
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、YotsuyaClient.rc ファイル内
...
YotsuyaClientDoc.h, YotsuyaClientDoc.cpp - ドキュメント
   これらのファイルは CYotsuyaClientDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CYotsuyaClientDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

YotsuyaClientView.h, YotsuyaClientView.cpp - ドキュメントのビュー
   これらのファイルは CYotsuyaClientView クラスを含みます。
   CYotsuyaClientView オブジェクトは CYotsuyaClientDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   YotsuyaClient.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
