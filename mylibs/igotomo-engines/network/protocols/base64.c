...
void* igx_base64_encode(const void* data,const size_t data_size,void* out_buffer,const size_t out_buffer_size,size_t* encoded_size)
{
...
void* igx_base64_decode(const void* data,size_t data_size,void* out_buffer,const size_t out_buffer_size,size_t* encoded_size)
{
...
void igx_base64_free(void* data)
{
    free(data);
}
size_t igx_base64_size(size_t n)
{
